...
TEST(TestTBinTree, check_func_erase6) {
	BSearchTree<int> tree;
	tree.insert(8);
	tree.insert(3);
	tree.insert(10);
	...
	ASSERT_EQ(tree.head()->value(), 9);
	ASSERT_EQ(tree.head()->right()->value(), 10);
	ASSERT_EQ(tree.head()->right()->right()->value(), 11);
	ASSERT_EQ(tree.head()->left()->value(), 3);
}

TEST(TestTBinTree, check_func_erase7) {
	BSearchTree<int> tree;
	tree.insert(5);
	tree.insert(3);
	tree.insert(4);
	...
	ASSERT_EQ(tree.head()->right()->value(), 4);
}

TEST(TestTBinTree, check_func_erase8) {
	BSearchTree<int> tree;
	tree.insert(5);
	tree.erase(5);
	ASSERT_EQ(tree.search(5), nullptr);
